...
/**
 * Home component presenting information about the Space Travel application.
 *
...
function Home() {
  return (
    <>
      ...
      {/* Section: Journey into the Future */}
      <section className={styles["section__container"]}>
      ...
      {/* Section: From Neglect to Innovation */}
      <section className={styles["section__container"]}>
      ...
      {/* Section: Engineer, Explorer, Leader */}
      <section className={styles["section__container"]}>
      ...
      {/* Section: A Universe of Possibilities Awaits */}
      <section className={styles["section__container"]}>
